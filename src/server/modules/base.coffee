...
exports.strings = {
    # Help messages
    'help-basic'    : 'For urgent help,  tweet @Quetzi'
    'help-requested': 'For urgent help,  tweet @Quetzi'
    ...
    'verify-err'    : '@1@: Invalid code. This feature is not in use.'
...
class Base extends Module
    ...
    cmdBot: (user, args) =>
        ...
        @bot.say "[#{botName}] #{Sauce.Server.Name} v#{Sauce.Version} by @RavnTM"
